<template>
  ...
  <table>
      ...
      <tbody>
                ...
                <tr @click="changedir(`/audit/details/${row.id}`)" v-for="row in filteredRows" :key="row.id">
                    ...
                    <td v-html="highlightMatches(row.withdrawalDate)"></td>
                    ...
                    <td v-html="highlightMatches(row.calculationDate)"></td>
                </tr>
      </tbody>
  </table>
